# -*- coding: utf-8 -*-
"""
Created on Mon Apr  1 04:04:17 2019

@author: rizvi
"""

from src.models.model7 import VAE
from src.experiments.experiment7 import MNIST_vae
...
logging.basicConfig(level=logging.DEBUG, format='%(asctime)s:%(levelname)s:%(message)s',
                    handlers=[
                        logging.FileHandler(log_dir / 'cvae'),
