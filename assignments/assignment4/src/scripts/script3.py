...
from src.models.model3 import VAE
from src.experiments.experiment3 import execute
...
def main(n, h, lr, epochs, bs, exp_dir):
    ...
    logging.basicConfig(level=logging.DEBUG, format='%(levelname)s-%(message)s',
                        handlers=[
                            logging.FileHandler(log_dir / 'experiment3'),
    ...
    # device = 'cpu'
    logging.info('n={},h={},lr={},epochs={},bs={},dest={},device={}'.format(n, h, lr, epochs, bs, exp_dir, device))
...
if __name__ == '__main__':
    ...
    # Execute experiments
    # ---------------------------------------------------------------
    exp_dir = Path('../../data/results/experiment3/')
